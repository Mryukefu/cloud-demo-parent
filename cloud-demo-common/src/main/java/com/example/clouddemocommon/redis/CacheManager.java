...
/*
    ...
    public Object RPush(String key, Object obj) {
        try {
     ...
     * @return
     */
    public boolean lUpdateIndex(String key, long index, List list) {
        try {
            redisTemplate.opsForList().set(key, index, list);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
