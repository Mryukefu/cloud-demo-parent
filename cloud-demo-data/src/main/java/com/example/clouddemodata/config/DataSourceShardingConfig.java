...
import com.example.clouddemocommon.entry.enumkey.BindingTableGroupsEnum;
...
@MapperScan(basePackages = {"com.project.sdkserver.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory",
