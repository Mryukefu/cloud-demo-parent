...
import com.example.clouddemodata.algorithm.TableRuleConfigurationFactionBuilder2;
...
@EnableScheduling
@Order(9999)
public class ActualTableRuleRefreshFromDbEvent1 implements InitializingBean {
	...
	private Collection<TableRule> structureNewTableRule(List<DbDataNodes> calculateRequiredTables)
		...
		for (String logicTableName : map.keySet()) {
			...
			tableShardingStrategyField.set(tableRule, TableRuleConfigurationFactionBuilder2
